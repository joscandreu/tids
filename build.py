...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.iamyellow.tids.js')
	...
	f = os.path.join(cwd,'Classes','NetIamyellowTidsModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','net.iamyellow.tids.js']
